...
@section('title', 'Add Subject | EduCore SMS')
@section('page_title', 'Add Subject')
@section('breadcrumb', '/ Academic Setup / Subjects / Add')
    ...
    <div class="data-card" style="max-width:600px;margin:0 auto;">
        ...
        <form action="{{ route('admin.subjects.store') }}" method="POST">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-control-sms @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Mathematics, English" required>
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-control-sms @error('code') is-invalid @enderror" type="text" id="code" name="code" value="{{ old('code') }}" placeholder="e.g. MATH-101">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <select class="filter-select @error('subject_type') is-invalid @enderror" id="subject_type" name="subject_type" required>
                    <option value="theory" @selected(old('subject_type') === 'theory')>Theory</option>
                    <option value="practical" @selected(old('subject_type') === 'practical')>Practical</option>
                    <option value="both" @selected(old('subject_type') === 'both')>Both</option>
                </select>
            ...
            <div style="margin-bottom:2rem;">
                <label style="display:flex;align-items:center;gap:.75rem;cursor:pointer;">
                    <input type="checkbox" name="is_optional" value="1" @checked(old('is_optional')) style="width:1.2rem;height:1.2rem;">
            ...
            <div style="display:flex;gap:1rem;">
                <button class="btn-primary-sms" type="submit"><i class="bi bi-save"></i> Save Subject</button>
