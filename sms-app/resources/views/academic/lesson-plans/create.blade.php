...
@section('title', 'Create Lesson Plan | EduCore SMS')
@section('page_title', 'Create Lesson Plan')
@section('breadcrumb', '/ Academics / Lesson Plans / Create')

@section('content')
    <div class="data-card" style="max-width:800px;margin:0 auto;">
        <div class="card-title">Lesson Plan Information</div>
        <form action="{{ route('admin.lesson-plans.store') }}" method="POST">
            @csrf
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-control-sms @error('lesson_name') is-invalid @enderror" type="text" id="lesson_name" name="lesson_name" value="{{ old('lesson_name') }}" placeholder="e.g. Introduction to Algebra" required>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
                <div>
                    ...
                    <input class="form-control-sms @error('date') is-invalid @enderror" type="date" id="date" name="date" value="{{ old('date') }}" required>
                ...
                <div>
                    ...
                    <input class="form-control-sms @error('time_from') is-invalid @enderror" type="time" id="time_from" name="time_from" value="{{ old('time_from') }}">
                ...
                <div>
                    ...
                    <input class="form-control-sms @error('time_to') is-invalid @enderror" type="time" id="time_to" name="time_to" value="{{ old('time_to') }}">
            ...
            <div style="margin-bottom:2rem;">
                ...
                <input class="form-control-sms @error('lecture_youtube_url') is-invalid @enderror" type="url" id="lecture_youtube_url" name="lecture_youtube_url" value="{{ old('lecture_youtube_url') }}" placeholder="https://youtube.com/watch?v=...">
                @error('lecture_youtube_url') <div style="color:var(--danger);font-size:.78rem;margin-top:.35rem;">{{ $message }}</div> @enderror
            </div>

            <div style="display:flex;gap:1rem;">
                <button class="btn-primary-sms" type="submit"><i class="bi bi-save"></i> Save Lesson Plan</button>
