...
<div class="page-header" style="margin-bottom: 2rem;">
    <div style="display: flex; align-items: center; gap: 1rem;">
        ...
        <div>
            <h1 style="font-size: 1.5rem; font-weight: 700; color: var(--charcoal); margin: 0;">Create New Role</h1>
            <p style="color: #64748b; margin-top: 0.25rem;">Define a new role and assign its permissions</p>
        </div>
    </div>
</div>
        ...
        <div class="col-md-4">
            <div class="card-sms mb-4">
                ...
                <div class="form-group-sms">
                    ...
                    <textarea name="description" class="form-control-sms @error('description') is-invalid @enderror" rows="3" placeholder="Briefly describe the responsibilities of this role...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
