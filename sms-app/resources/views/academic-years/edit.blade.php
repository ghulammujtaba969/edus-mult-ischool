...
@section('title', 'Edit Academic Year | EduCore SMS')
@section('page_title', 'Edit Academic Year')
@section('breadcrumb', '/ Academic Setup / Academic Years / Edit')
    ...
    <div class="data-card" style="max-width:600px;margin:0 auto;">
        ...
        <form action="{{ route('admin.academic-years.update', $academicYear) }}" method="POST">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-control-sms @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name', $academicYear->name) }}" placeholder="e.g. 2024-2025" required>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
                <div>
                    ...
                    <input class="form-control-sms @error('start_date') is-invalid @enderror" type="date" id="start_date" name="start_date" value="{{ old('start_date', $academicYear->start_date->format('Y-m-d')) }}" required>
                ...
                <div>
                    ...
                    <input class="form-control-sms @error('end_date') is-invalid @enderror" type="date" id="end_date" name="end_date" value="{{ old('end_date', $academicYear->end_date->format('Y-m-d')) }}" required>
            ...
            <div style="margin-bottom:2rem;">
                <label style="display:flex;align-items:center;gap:.75rem;cursor:pointer;">
                    <input type="checkbox" name="is_current" value="1" @checked(old('is_current', $academicYear->is_current)) style="width:1.2rem;height:1.2rem;">
            ...
            <div style="display:flex;gap:1rem;">
                <button class="btn-primary-sms" type="submit"><i class="bi bi-save"></i> Update Year</button>
