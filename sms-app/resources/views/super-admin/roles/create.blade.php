...
@section('title', 'Create Role | SaaSAdmin')
@section('page_title', 'Create Global Role')
@section('breadcrumb', 'Super Admin / Access Control / Roles / Create')
    ...
    <div class="container-fluid p-0">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h1 class="h3 font-weight-bold text-dark mb-0">Create Global Role</h1>
                <p class="text-muted small mb-0 mt-1">Define a new role and assign its foundational capabilities for all school tenants.</p>
            </div>
            <div class="col-auto">
...
<div class="container-fluid p-0" x-data="{
    ...
    <form action="{{ route('super-admin.roles.store') }}" method="POST" class="has-sticky-bar">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-0">
                            ...
                            <textarea class="form-control-sms @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Briefly describe the responsibilities and scope of this role...">{{ old('description') }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="card-sms shadow-sm mb-4 sticky-top" style="top: 20px;">
                    <div class="card-header-sms py-3 px-4 border-bottom">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <i class="bi bi-lightbulb mr-2"></i> Role Guidelines
                        </h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="guideline-item mb-4">
                            <h6 class="font-weight-bold small text-dark">Global Scope</h6>
                            <p class="text-muted small mb-0">These roles are "Base Roles". Every school tenant will have these roles available to assign to their staff.</p>
                        </div>
                        <div class="guideline-item mb-4">
                            <h6 class="font-weight-bold small text-dark">Principle of Least Privilege</h6>
                            <p class="text-muted small mb-0">Only assign permissions that are absolutely necessary for the role's intended functions.</p>
                        </div>
                        <div class="guideline-item mb-0">
                            <h6 class="font-weight-bold small text-dark">Permission Inheritance</h6>
                            <p class="text-muted small mb-0">Permissions assigned here will be automatically granted to any user who is assigned this role in any school.</p>
                        </div>
                    </div>
                </div>
            </div>
