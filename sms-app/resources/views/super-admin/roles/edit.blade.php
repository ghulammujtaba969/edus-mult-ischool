...
@section('title', 'Edit Global Role')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Global Role: {{ $role->name }}</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('super-admin.roles.update', $role) }}" method="POST">
                ...
                <hr>
                <button type="submit" class="btn btn-primary btn-lg px-5">Update Global Role</button>
            </form>
        </div>
    </div>
</div>
