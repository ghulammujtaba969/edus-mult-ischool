...
@section('title', 'Edit Section | EduCore SMS')
@section('page_title', 'Edit Section')
@section('breadcrumb', '/ Academic Setup / Sections / Edit')
    ...
    <div class="data-card" style="max-width:600px;margin:0 auto;">
        ...
        <form action="{{ route('admin.sections.update', $section) }}" method="POST">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <select class="filter-select @error('school_class_id') is-invalid @enderror" id="school_class_id" name="school_class_id" required>
                    ...
                    @foreach($classes as $class)
                        <option value="{{ $class->id }}" @selected(old('school_class_id', $section->school_class_id) == $class->id)>{{ $class->name }}</option>
                    @endforeach
                </select>
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-control-sms @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name', $section->name) }}" placeholder="e.g. A, Blue, Rose" required>
            ...
            <div style="margin-bottom:2rem;">
                ...
                <input class="form-control-sms @error('capacity') is-invalid @enderror" type="number" id="capacity" name="capacity" value="{{ old('capacity', $section->capacity) }}" min="0" required>
            ...
            <div style="display:flex;gap:1rem;">
                <button class="btn-primary-sms" type="submit"><i class="bi bi-save"></i> Update Section</button>
