<aside class="sidebar">
    ...
    <div class="session-badge" style="background: rgba(232,93,58,0.1); border: 1px solid rgba(232,93,58,0.2);">
        <div class="session-dot" style="background: var(--coral);"></div>
        <div>
            <div style="font-size:.75rem;color:var(--charcoal-muted);">System Status</div>
            <div style="font-weight:700;color:white;">Super Portal</div>
        </div>
    </div>
