...
<div class="page-login">
    ...
    <div class="login-right">
        <div class="auth-card">
            ...
            <?php if($errors->any()): ?>
                <div class="alert-box"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            ...
            <form action="<?php echo e(route('login.store')); ?>" method="POST">
                ...
                <div style="margin-bottom:1rem;">
                    ...
                    <input class="form-control-sms" id="email" name="email" type="email" value="<?php echo e(old('email', 'admin@alfalah.edu.pk')); ?>" required>
                </div>
                <div style="margin-bottom:1rem;">
...
<?php /**PATH D:\xampp8.1\htdocs\SMS\codex\sms-app\resources\views/auth/login.blade.php ENDPATH**/ ?>